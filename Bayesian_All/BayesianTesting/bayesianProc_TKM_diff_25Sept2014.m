...
% User parameters
%
datafile= '/Users/tyler/Dropbox/Coding/Nick_Coding/Data/glycerol_n16_256Echoes_120tE_20June2014.tnt';
...
rangeMin = 1e-6;    % minimum examination range (s)
rangeMax = 2e-2;    % maximum examination range (s)
D = 2.2e-9;         % diffusion constant m^2/s
...
opts.priorCov = diag([10000^2*ones(length(T2guess),1); 1000000^2*ones(length(T2guess),1); 100^2*ones(2,1)]);
opts.tau = tEcho;
opts.sigma2 = (1./SNR)^2;
opts.D = D;
opts.G = G;
