function [xfit,ypred,beta,pm,resid] = monodecay_t2fit_stretched(xdata,ydata,guesses,CI)

% fitting routine and plotting
[beta,resid,J] = nlinfit(xdata,ydata,@t2monofit_stretched,guesses);
...
ypred = nlpredci(@t2monofit_stretched,xfit,beta,resid,J);
