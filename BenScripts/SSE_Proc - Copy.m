...
cd(maindir);
adirnums = [2 3 5 6 7 8 9 10 11 12 14 15]; % for armory
atime = [1 10 12 14 30 33 35 37 39 42 44 46] % for armory change when adding more data
...
jdirnums = [1 : 11]; %for jamestown
jtime = [1 10 12 14 16 30 35 39 42 44 46] %for jamestown
