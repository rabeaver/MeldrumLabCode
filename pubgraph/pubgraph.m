...
set(axs, 'FontSize', FS, 'LineWidth', LW,'Color',CL, 'FontName',FN) %make everything on the axis correct
set(findall(fh, 'Type', 'text'), 'FontSize', FS,'FontName',FN); 	%make all other text correct ,'FontName','Calibri'
...
%     YTick = str2num(get(ax{1},'YTickLabel'));          %get the current Y axis labels
%     XTick = str2num(get(ax{1},'XTickLabel'));          %get the current X axis labels
