...
%if fixed alpha
%    AlphaStart = 1;                        % Minimum value of log10(Alpha)
%    Alpha_Auto = 1;                % Flag that indicates if alpha is automatically chosen
                                    % 0 : if alpha is fixed
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    switch Alpha_Auto 
        ...
        case {0,1}	% 0:for a fixed alpha, 
            ...
            [FEst, CompressedData, Chi, Alpha_heel] = FLIEstimate(Data,  U1, U2, V1, V2, S1, S2,AlphaStart, NoiseStd, Alpha_Auto, ConditionNumber);
