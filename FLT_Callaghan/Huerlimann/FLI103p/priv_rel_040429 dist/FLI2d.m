function [FEst, Alpha_heel, Fitdata] = FLI2d(inData,inKernel1,inKernel2,inAlpha,U1,S1,V1,U2,S2,V2)
%   Two-dimensional inversion of Folh integral, including Laplace
%   inversion.
%   Syntax:
%   [FEst, Alpha_heel, Fitdata] = FLI2d(inData,inKernel1,inKernel2,inAlpha,U1,S1,V1,U2,S2,V2)
%   [FEst, Alpha_heel, Fitdata] = FLI2d(inData,inKernel1,inKernel2,inAlpha)
%
%
%	inData : data matrix
%	inKernel1 and inKernel2: kernel matrice
% 	inAlpha: 0:BRD method, 
%			positive constant: fixed reg, 
%			-1:full span, 
%			-2:t1heel method.
%
%	U1,S1,V1: K1=U1*S1*V1', U2,S2,V2: K2=U2*S2*V2',
%   if they are provided, then SVD of K1 and K2 will be skipped.
...
%
%   t1heel method: 
%       Fordham et al, JMRA 113,139-150 (1995).
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
      ...
      % SVD of inKernel
     	...
     	%fprintf(1, '%d\n',e);
            ...
            fprintf(1,'Use the input SVD: U,V,S ... ');
             ...
             fprintf(1,'FLI2d will return without further calculation.');
             return
         end
     end
