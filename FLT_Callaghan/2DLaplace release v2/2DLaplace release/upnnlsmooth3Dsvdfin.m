function [spectrum,taua,taub,chisq,compte]=upnnlsmooth3Dsvdfin(data,timea,timeb,Tamm,stepsa,Tbmm,stepsb,alpha,beta,orient)
...
%     new size of the data after compression of the data but svd
    ...
    if orient == 'h'
        [spectrum, chisq,compte]=nnlsmooth3Dsvdhorfin(data, timea, timeb, taua, taub, spectrum, weighting);
    elseif orient == 'v'
        [spectrum, chisq,compte]=nnlsmooth3Dsvdverfin(data, timea, timeb, taua, taub, spectrum, weighting);
    elseif orient == 'b'
        [spectrumh, chisq,compte]=nnlsmooth3Dsvdhorfin(data, timea, timeb, taua, taub, spectrum, weighting);
		compte_temp=compte;
        [spectrumv, chisq,compte]=nnlsmooth3Dsvdverfin(data, timea, timeb, taua, taub, spectrum, weighting);
