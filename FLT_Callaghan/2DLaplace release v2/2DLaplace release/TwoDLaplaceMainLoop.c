/*
 *TKM 8 May 2013
 *Added "#include <string.h>" to resolve some compile errors associated with warning: incompatible implicit declaration of built-in function
 *Changed line 71 "mxCreateScalarDouble" to "mxCreateDoubleScalar" to make compatible with deprecated commands
 *
 */
