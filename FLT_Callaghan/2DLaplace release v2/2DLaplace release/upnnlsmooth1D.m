function [spectrum,tau,chisq,compte]=upnnlsmooth1D(data,time,Tamin,Tamax,alpha,beta,steps)
...
for uploop = 1 : Max
    ...
    [spectrum, chisq,compte]=nnlsmooth1Dsvd(spectrum,weighting, tau, time, data);
